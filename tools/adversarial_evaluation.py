...
class SkepticalInvestor:
    ...
    def evaluate(self, idea: Dict[str, Any]) -> Dict[str, Any]:
        ...
        print(f"💰 {self.role}: Evaluating {idea.get('name', 'idea')}...")
...
class TechnicalRealist:
    ...
    def evaluate(self, idea: Dict[str, Any]) -> Dict[str, Any]:
        ...
        print(f"⚙️ {self.role}: Evaluating {idea.get('name', 'idea')}...")
...
class AdversarialEvaluator:
    ...
    def run_evaluation(self) -> Dict[str, Any]:
        ...
        print(f"🚀 Starting Adversarial Evaluation")
        ...
        for i, idea in enumerate(ideas, 1):
            ...
            if result['verdict'] == 'KILL':
                print(f"❌ KILLED by {result['killed_by']}: {result['kill_reason']}")
            else:
                print(f"✅ SURVIVED (Score: {result['total_score']}/50)")
...
"""
            ...
            for persona, evaluation in result['evaluations'].items():
                emoji = "✅" if evaluation['score'] >= 7 else "⚠️" if evaluation['score'] >= 5 else "❌"
...
def main():
    ...
    if "error" not in results:
        ...
        print(f"🎯 {results['ideas_survived']} ideas ready for validation research")
